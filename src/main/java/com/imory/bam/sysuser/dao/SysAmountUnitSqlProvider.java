 ...
 * @Date 2017/7/20
 */
public class SysAmountUnitSqlProvider {

    public String listSysAmountUnit(Map<String, Object> paramsMap)
    {
        String qryVal = (String) paramsMap.get("qryVal");
        StringBuffer sql = new StringBuffer();
        sql.append("select * from sys_amountUnit where 1 = 1\n");
    ...
    public String countSysAmountUnit(Map<String, Object> paramsMap)
    {
        String qryVal = (String) paramsMap.get("qryVal");
        StringBuffer sql = new StringBuffer();
        sql.append("select count(*) from sys_amountUnit where 1 = 1\n");
        if (StringUtils.isNotBlank(qryVal))
        {
            sql.append("and name like '%" + qryVal + "%' \n");
            sql.append("or code like '%" + qryVal + "%'");
    ...
    public String deleteByIds(Map<String, Object> paramsMap)
    {
        ...
        StringBuffer sql = new StringBuffer();
        sql.append("delete from sys_amountUnit where id in \n");
        sql.append("(\n");
